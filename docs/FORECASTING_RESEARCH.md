...
>
> Still pending (see docs/TODO.md): ACI/DtACI conformal calibration (§16.4 step 2), history-length seasonality gating (§16.3), and the inflow/outflow split spike (§16.2).
