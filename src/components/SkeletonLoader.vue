  ...
  <div class="animate-pulse" role="status" aria-label="Loading...">
    ...
    <template v-if="variant === 'dashboard'">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 mb-6">
        <div v-for="i in 4" :key="i" class="bg-white rounded-lg border border-gray-200 p-4">
      ...
      <div class="bg-white rounded-lg border border-gray-200 p-4 mb-6">
        <div class="h-48 sm:h-64 bg-gray-100 rounded" />
      </div>
      <!-- Table rows -->
      <div class="space-y-2">
    ...
    <template v-else-if="variant === 'list'">
      <div class="space-y-3">
        <div v-for="i in 3" :key="i" class="bg-white rounded-lg border border-gray-200 p-4">
          ...
          <div class="h-3 bg-gray-200 rounded w-64" />
        </div>
      </div>
    </template>
