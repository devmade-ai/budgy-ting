...
<template>
  <div>
    ...
    <label
      class="bg-base-100 rounded-xl border-2 border-dashed border-base-300 hover:border-primary transition-colors cursor-pointer flex flex-col items-center justify-center py-12 p-4"
    >
