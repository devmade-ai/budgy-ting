  ...
  <div>
      ...
      <div class="max-w-sm mx-auto mt-8 mb-8 space-y-4">
        ...
        <div>
          ...
          <div class="h-1.5 bg-base-200 rounded-full overflow-hidden">
            <div
              ...
              :class="embeddingError ? 'bg-amber-400' : 'bg-primary'"
        ...
        <div>
          ...
          <div class="h-1.5 bg-base-200 rounded-full overflow-hidden">
            <div
              class="h-full rounded-full transition-all duration-300"
              :class="tagModelError ? 'bg-amber-400' : 'bg-primary'"
        ...
        <p class="text-xs text-base-content/50 text-center">
          ...
          <template v-else-if="embeddingError || tagModelError">
            ...
            <button
              class="block mx-auto mt-2 text-primary hover:opacity-80 underline"
    ...
    <template v-else>
      ...
      <div class="flex flex-wrap gap-3 mb-4 text-sm">
        ...
        <span class="text-base-content/50">{{ summary.ignored }} ignored</span>
      ...
      <div class="mb-4 flex flex-wrap items-center gap-3">
        ...
        <span v-if="tagModelLoading" class="text-xs text-base-content/50 italic">
      ...
      <div class="space-y-2 mb-4">
        <div
          ...
          :class="{
            'border-info/20 bg-info/10': !tx.ignored && tx.classification === 'recurring',
          ...
          <div class="flex flex-wrap items-start gap-2">
            ...
            <div class="flex-1 min-w-0">
              ...
              <div v-if="tx.tags.length > 0" class="flex flex-wrap gap-1 mt-1">
                <span
                  ...
                  :key="tag"
                  class="badge badge-ghost text-xs inline-flex items-center gap-0.5"
                >
                  {{ tag }}
                  <button
              ...
              <div v-if="!tx.ignored" class="mt-1.5">
                <button
                  ...
                  class="text-xs text-base-content/50 hover:text-info transition-colors"
                ...
                <div v-else class="relative">
                  <input
                    ...
                    class="input input-bordered text-base text-xs w-full py-1.5 px-2"
                    role="combobox"
            ...
            <div class="flex flex-col gap-1 items-end flex-shrink-0">
              ...
              <button
                ...
                :class="tx.ignored
                  ? 'text-error hover:text-error font-medium'
